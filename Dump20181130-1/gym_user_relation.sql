...
CREATE TABLE `user_relation` (
  ...
  KEY `following_id_fk_idx` (`following_id`),
  CONSTRAINT `follower_id_fk` FOREIGN KEY (`follower_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-11-30 15:07:54
